...
use app\models\KompensasiDanBenefitBulananSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * KompensasidanbenefitbulananController implements the CRUD actions for KompensasiDanBenefitBulanan model.
 */
class KompensasidanbenefitbulananController extends Controller
{
    ...
    {
        $searchModel = new KompensasiDanBenefitBulananSearch();
