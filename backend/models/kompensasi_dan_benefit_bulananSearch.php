...
/**
 * kompensasi_dan_benefit_bulananSearch represents the model behind the search form about `app\models\KompensasiDanBenefitBulanan`.
 */
class kompensasi_dan_benefit_bulananSearch extends KompensasiDanBenefitBulanan
{
    /**
     * @inheritdoc
     */
